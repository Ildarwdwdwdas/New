...
case $distro_version in
  "22.04" | "22.10" | "23.04" | "23.10") # Ubuntu 22.04/22.10/23.04/23.10 — системные репо + опционально deadsnakes не обязателен
    ;;
  "24.04" | "24.10") # Ubuntu 24.04/24.10 — добавляем deadsnakes для Python 3.11
